...
const login = async function (req, res, next) {
  ...
  try {
    ...
    res.json({ user: { _id: user._id, imageUrl: user.imageUrl, firstName: user.firstName, lastName: user.lastName, name: user.name, username: user.username, email: user.email, coin: user.coin, phone: user.phone, gender: user.gender, roles: user.roles }, token })
  } catch (err) {
